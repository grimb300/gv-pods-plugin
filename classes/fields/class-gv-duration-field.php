...
class GV_Duration_Field extends PodsField {
  ...
  public function display( $value = null, $name = null, $options = null, $pod = null, $id = null  ) {
    ...
    $view = apply_filters( 'pods_ui_field_gv_duration_display_view', $view, $display_type, $value, $name, $options, $pod, $id );
    ...
    $output = apply_filters( 'pods_ui_field_gv_duration_display_value', $output, $value, $view, $display_type, $name, $options, $pod, $id );
  ...
  public function input( $name, $value = null, $options = null, $pod = null, $id = null ) {
    ...
    $view = apply_filters( 'pods_ui_field_gv_duration_input_view', $view, $type, $name, $value, $options, $pod, $id );
    ...
    do_action( 'pods_ui_field_gv_duration_input_view_extra', $view, $type, $name, $value, $options, $pod, $id );
  }
  ...
  public function validate( $value, $name = null, $options = null, $fields = null, $pod = null, $id = null, $params = null ) {
    ...
    $errors = apply_filters( 'pods_ui_field_gv_duration_validate', $errors, $value, $type, $name, $options, $fields, $pod, $id, $params );
  ...
  public function pre_save( $value, $id = null, $name = null, $options = null, $fields = null, $pod = null, $params = null ) {
    ...
    $value = apply_filters( 'pods_ui_field_gv_duration_pre_save', $value, $type, $id, $name, $options, $fields, $pod, $params );
  ...
  public static function format_to_html( $format, $value, $options ) {
    ...
    if ( ! empty( $value[ 'gv_duration' ] ) ) {
      $phone_numbers = $value[ 'gv_duration' ];
    }
